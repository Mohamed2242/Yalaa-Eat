namespace Angular_API.Helpers
{
    ...
    <div style=""height: auto; background: linear-gradient(to top, #c9c9ff 50%, #6e6ef6 90%) no-repeat; width: 400px; padding: 20px; margin: 0 auto;"">
        ...
        <hr>
        <p>You're receiving this email because you requested a password reset for your Yallaa Eat account.</p>
        ...
        <p>Kind Regards,<br><br>YallaaEat</p>
    </div>
</body>
</html>";
		}
